...
mv README.md README.md.tpl; cat README.md.tpl | sed -E "s%(Ansible\ Snippets).*%\1 ${CI_NEXT_TAG}%" | sed -E "s%Ansible\ (.*)\+%Ansible ${ANSIBLE_VERSION} +%" > README.md; rm README.md.tpl
git add README.md
